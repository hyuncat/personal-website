---
title: "A graph theory algorithm for designing DNA strands"
description: "This problem's at least a LeetCode hard."
date: '2025-10-20'
tags: ['research', 'cs', 'algorithms']
authors: ['sarah']
draft: false
---
...
<PostImage src={img1} alt="A strand of DNA which 'folds' into an octahedral wireframe." size="md" quality="max" caption="A strand of DNA which 'folds' into an octahedral wireframe." captionOverlay={true}/>
{/* <PostImage src={img2} alt="DNA origami self-assembling into a lattice structure." size="md" quality="max" caption="DNA origami self-assembling into a lattice structure." captionOverlay={true}/> */}
...
<PostImage src={img3} alt="DNA origami self-assembling into a lattice structure." size="md" quality="max" caption="DNA origami self-assembling into a lattice structure." captionOverlay={true}/>
...
<PostImage src={img2} alt="Two voxels on the left connect with complementary bonds to form the structure on the right." size="md" quality="max" caption="Two voxels on the left connect with complementary bonds to form the structure on the right." captionOverlay={true}/>
...
<PostImage src={img5} alt="A problem of excess base pair overlap." size="lg" quality="max" caption="A problem of excess base pair overlap." captionOverlay={true}/>
...
<PostImage src={img9} alt="Basic graph definitions" size="lg" quality="max" caption="Basic graph definitions" captionOverlay={true}/>
...
<PostImage src={img10} alt="The minimally-connected graph algorithm" size="lg" quality="max" caption="The minimally-connected graph algorithm" captionOverlay={true}/>
