...
description: 'How implementing a RAG reconnected me with my spirituality.'
date: '2025-12-24'
tags: ['personal', 'philosophy', 'religion', 'meaning']
authors: ['sarah']
draft: false
---
import PostImage from '@/components/PostImage.astro'
import parable from './parable.png'
...
Gradually, I stopped praying and attending mass. And during the height of the COVID pandemic, the overlap between religious Christians and anti-mask + anti-vaccine Americans pushed me over the edge—I proclaimed myself agnostic.
...
<PostImage src={parable} alt="Brian's Dance with the Way 🧘‍♀️" size="xl" quality="max" caption="Brian's Dance with the Way 🧘‍♀️" captionOverlay={true}/>
