...
description: 'Lessons on leadership and community from organizing a hardware hackathon.'
date: '2025-11-12'
tags: ['robotics', 'personal', 'leadership', 'retrospective']
authors: ['sarah']
draft: false
---
import PostImage from '@/components/PostImage.astro'
import meandjo from './meandjo.jpg'
...
<PostImage src={meandjo} alt="🌷" size="md" caption="🌷" captionOverlay={true}/>
...
PS. We met to film a couple of marketing reels over the summer. Here's some of my favorites from then.
- [Me falling](https://www.instagram.com/reel/DNN_reCMlzQ/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==)
