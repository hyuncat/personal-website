...
description: 'A greedy algorithm for creating self-assembling materials applying the group theoretic notion of symmetry onto lattices.'
date: '2025-04-15'
tags: ['cs', 'algorithm', 'research']
authors: ['sarah']
draft: false
---
...
<PostImage src={img1} alt="The lattice pattern we want to self-assemble" size="lg" quality="max" caption="The lattice pattern we want to self-assemble" captionOverlay={true}/>
...
<PostImage src={img4} alt="The origami building blocks" size="sm" quality="max" caption="The origami building blocks" captionOverlay={true}/>
...
<PostImage src={img2} alt="A bad coloring job" size="lg" quality="max" caption="A bad coloring job" captionOverlay={true}/>
...
<PostImage src={img5} alt="The minimum design" size="sm" quality="max" caption="The minimum design" captionOverlay={true}/>
...
<PostImage src={img6} alt="The 180 degree symmetry between v1 and v4" size="xl" quality="max" caption="The 180 degree symmetry between v1 and v4" captionOverlay={true}/>
...
<PostImage src={img7} alt="The first color" size="md" quality="max" caption="The first color" captionOverlay={true}/>
...
<PostImage src={img8} alt="The first color mapped onto the rest of the equivalence class" size="md" quality="max" caption="The first color mapped onto the rest of the equivalence class" captionOverlay={true}/>
...
<PostImage src={img9} alt="The second color" size="md" quality="max" caption="The second color" captionOverlay={true}/>
...
<PostImage src={img10} alt="The second color mapped onto the rest of the equivalence class" size="md" quality="max" caption="The second color mapped onto the rest of the equivalence class" captionOverlay={true}/>
...
<PostImage src={img11} alt="The third color" size="md" quality="max" caption="The third color" captionOverlay={true}/>
...
<PostImage src={img12} alt="The fourth color" size="md" quality="max" caption="The fourth color" captionOverlay={true}/>
...
<PostImage src={img14} alt="The last color" size="md" quality="max" caption="The last color" captionOverlay={true}/>
...
<PostImage src={img15} alt="The final assembled structure" size="xl" quality="max" caption="The final assembled structure" captionOverlay={true}/>