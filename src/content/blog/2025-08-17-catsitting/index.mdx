...
description: 'How being responsible for feeding a cat made me come face-to-face with my void of intrinsic motivation.'
date: '2025-08-17'
tags: ['research', 'personal', 'retrospective']
authors: ['sarah']
draft: false
---
import PostImage from '@/components/PostImage.astro'
import maslow from './maslow.png'
...
- *"Live truthfully"* $\leftarrow$ My fundamental axiom
...
<PostImage src={maslow} alt="Maslow's hierarchy of needs" size="xl" caption="Maslow's hierarchy of needs." captionOverlay={true}/>
