...
description: 'A series of terrible purchases, and the angry reflections which sprouted in their wake.'
date: '2025-06-23'
tags: ['media', 'personal', 'stupid']
authors: ['sarah']
draft: false
---
import PostImage from '@/components/PostImage.astro'
import ballOfDuty from './ball_of_duty.png'
import code118 from './code118.png'
import mitiru66 from './mitiru66.jpg'
import evangelion from './evangelion.jpg'
import bare from './bare.jpg'
...
<PostImage src={bare} alt="A naked keyboard 🫣" size="md" caption="A naked keyboard 🫣" captionOverlay={true}/>
<PostImage src={evangelion} alt="The finished build." size="md" caption="The finished build." captionOverlay={true}/>
...
I saw cute and creative pencil sharpeners from a Japanese creator called [mitiru66](https://www.instagram.com/mitiru66/).

<PostImage src={mitiru66} alt="A pencil sharpener shaped like a takoyaki whose pencil shavings turn into bonito flakes." size="sm" caption="A pencil sharpener shaped like a takoyaki whose pencil shavings turn into bonito flakes." captionOverlay={true}/>

And watched an [Asian guy](https://www.instagram.com/kydyuzhini/) rate whether viral products were worth the hype or not. 

<PostImage src={ballOfDuty} alt="The 'Ball of Duty'" size="sm" caption="The 'Ball of Duty'" captionOverlay={true}/>
...
<PostImage src={code118} alt="A well-marketed $50 scrap of metal" size="sm" caption="A well-marketed $50 scrap of metal." captionOverlay={true}/>
