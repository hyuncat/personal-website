...
description: 'How can we determine the pitch of a possibly complicated 2D audio signal at any time?'
date: '2025-03-22'
tags: ['algorithms', 'audio-processing', 'music']
authors: ['sarah']
draft: false
---
...
<PostImage src={img1} alt="The simulated audio signal, which is a complex waveform with a fundamental frequency of 440 Hz." size="lg" quality="max" caption="A simulated audio signal with present harmonics and a fundamental frequency of 440 Hz." captionOverlay={true}/>
...
<PostImage src={img2} alt="An audio frame and its autocorrelation, power spectrum, and detected amplitudes" size="lg" quality="max" caption="An audio frame and its autocorrelation, power spectrum, and detected amplitudes" captionOverlay={true}/>
...
<PostImage src={img3} alt="The difference function." size="lg" quality="max" caption="The difference function." captionOverlay={true}/>
...
<PostImage src={img4} alt="The difference function and its edited + normalized CMNDF curve." size="lg" quality="max" caption="The difference function and its edited + normalized CMNDF curve." captionOverlay={true}/>
...
<PostImage src={img5} alt="The troughs of the difference function and CMNDF curves." size="lg" quality="max" caption="The troughs of the difference function and CMNDF curves." captionOverlay={true}/>
...
<PostImage src={img6} alt="The original audio signal versus the signal shifted by the lags corresponding to the troughs of the difference function and CMNDF." size="lg" quality="max" caption="The original audio signal versus the signal shifted by the lags corresponding to the troughs of the difference function and CMNDF." captionOverlay={true}/>
